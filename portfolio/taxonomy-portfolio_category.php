<?php
/**
 * Оптимизированный шаблон категории портфолио
  ...
  <div class="container">
    ...
    <nav aria-label="breadcrumb" class="mb-0">
      <ol class="breadcrumb bg-transparent p-0 m-0">
        ...
        <li class="breadcrumb-item">
          <a href="<?php echo get_post_type_archive_link('portfolio'); ?>" class="text-decoration-none text-secondary">
            Наши работы
          </a>
        </li>
...
<?php
// Подключаем общий шаблон модального окна (для таксономии используем стандартные ID)
